...
urlpatterns = [
    ...
    path('api/change-password/', views.ChangePasswordAPI.as_view(), name='change-password'),
    ...
    path('api/subject_create/', views.SubjectCreateView.as_view(), name='subject-create'),
